...
#define STRING_CONFIG_H_AUTHOR "(Felipe JJ, 2.0.x)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MARK IV"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2520, 100 }
...
//#define DISABLE_REDUCED_ACCURACY_WARNINfG
