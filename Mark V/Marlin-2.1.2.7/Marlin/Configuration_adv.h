 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        60 // MARK V - (seconds)
 ...
 */
#define USE_CONTROLLER_FAN // MARK V
#if ENABLED(USE_CONTROLLER_FAN)
  #define CONTROLLER_FAN_PIN PB15 // MARK V - PINO 2
  ...
  #define CONTROLLER_FAN_EDITABLE         // MARK V - Enable M710 configurable settings
 ...
 */
#define E0_AUTO_FAN_PIN PC7 // MARK V - PINO 1
...
// @section bltouch
   ...
   */
  #define BLTOUCH_HS_MODE true // MARK V
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define LONG_FILENAME_HOST_SUPPORT      // MARK V
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES           // MARK V
   ...
   */
  #define SDCARD_CONNECTION LCD // MARK V
 ...
 */
#define BABYSTEPPING // MARK V
#if ENABLED(BABYSTEPPING)
  //#define INTEGRATED_BABYSTEPPING         // EXPERIMENTAL integration of babystepping into the Stepper ISR
  //#define BABYSTEP_WITHOUT_HOMING
  #define BABYSTEP_ALWAYS_AVAILABLE         // MARK V
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING    // MARK V
 ...
 */
#define EMERGENCY_PARSER // MARK V
 ...
 */
#define ADVANCED_PAUSE_FEATURE // MARK V
 ...
 */
   ...
   */
  #define MONITOR_DRIVER_STATUS // MARK V
   ...
   */
  #define HYBRID_THRESHOLD // MARK V

  #define X_HYBRID_THRESHOLD     100  // [mm/s]
  #define X2_HYBRID_THRESHOLD    100
  #define Y_HYBRID_THRESHOLD     100
  #define Y2_HYBRID_THRESHOLD    100
  #define Z_HYBRID_THRESHOLD       15 // MARK V
