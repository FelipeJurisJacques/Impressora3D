...
#define USE_CONTROLLER_FAN // MARK V
  ...
  #define CONTROLLER_FAN_PIN FAN0_PIN // MARK V
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN // MARK V
...
#define BABYSTEPPING // MARK V
  ...
  #define BABYSTEP_ZPROBE_OFFSET            // MARK V
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    #define BABYSTEP_ZPROBE_GFX_OVERLAY     // MARK V
  #endif
#endif
